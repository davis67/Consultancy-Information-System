  ...
  <div id="right-sidebar" class="settings-panel">
    ...
    <ul class="nav nav-tabs bg-gradient-danger" id="setting-panel" role="tablist">
      <li class="nav-item">
        ...
        <div class="add-items d-flex px-3 mb-0">
          <form class="form w-100">
            <div class="form-group d-flex">
              ...
              <button type="submit" class="add btn btn-gradient-danger btn-sm todo-list-add-btn" id="add-task">Add</button>
            </div>
          </form>
        </div>

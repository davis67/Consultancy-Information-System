...
<div class="card-body">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom:40px;">
        <a href="{{redirect()->back() }}" class="btn btn-outline-danger btn-sm"><i class="fa fa-plus"></i>back to tasks</a>
...
<form id="task_form" action="{{ route('subtasks.store') }}" method="POST">
    ...
    <div class="row">
    <div class="col-md-8">
        <label>Create Sub new task <span class="fa fa-plus" aria-hidden="true"></span></label>

        <div class="form-group">
                <input type="hidden" class="form-control"  name="task_id" value="{{ $id }}">

            <input type="text" class="form-control" placeholder="Enter Task Title" name="name">
        </div>
        <div class="form-group">
            <textarea class="form-control my-editor" rows="10" id="task" name="task_title"></textarea>
        </div>
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <select id="user" name="user_id" class="form-control selectpicker" data-style="btn-info" style="width:100%;">

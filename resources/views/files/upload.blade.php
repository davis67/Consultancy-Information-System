					...
					<tbody>
							...
							<td>
									<form action="{{ route('deletefile', $file->id) }}" method="post">
											@csrf
											@method('DELETE')
											<a href="{{ route('downloadfile', $file->id) }}" class="btn btn-primary btn-xs"><i class="fa fa-download"></i>Download</a>
											<a href="{{ route('emailfile', $file->id) }}" class="btn btn-success btn-xs"><i class="fa fa-email"></i>Email</a>
